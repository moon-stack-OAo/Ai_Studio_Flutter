...
/// M-VideoParams + M-PromptBox + M-VideoPrimary。
...
class _VideoComposerState extends State<VideoComposer> {
  ...
  Widget build(BuildContext context) {
    ...
    final canPickRef =
        widget.supportsReferenceImage && !widget.generating;
                    ...
                    children: [
                      Expanded(
                        child: _dropdown<int>(
                          tokens: tokens,
                          label: '时长',
                          value: widget.durationOptions.contains(widget.duration)
                              ? widget.duration
                              : widget.durationOptions.first,
